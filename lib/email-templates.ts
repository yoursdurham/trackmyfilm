...
// ─── Email 2: 5th drop-off loyalty milestone ──────────────────────────────
export function filmDropLoyalty5(params: {
  firstName: string;
  rollCount: number;
  filmType: string;
  filmProcess: string;
  ...
  const { firstName, rollCount, filmType, filmProcess, orderNumber } = params;
  return {
    subject: "We've got your film — and a thank you! 🎉",
    html: layout("Yours Film Drop — 5th Visit!", `
      <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#1a1a1a;">Hey ${firstName}!</h1>
      <p style="margin:0;color:#4b5563;font-size:15px;line-height:1.6;">
        This is your <strong>5th time</strong> dropping off with us — we genuinely appreciate you trusting us with your memories. 💛
      </p>
      <!-- Loyalty reward -->
      <table width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0;background:#fffbeb;border:2px solid #f59e0b;border-radius:10px;">
        <tr><td style="padding:20px 24px;">
          <p style="margin:0 0 4px;color:#92400e;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;">Your Loyalty Rewards</p>
          <p style="margin:0 0 16px;color:#78350f;font-size:14px;">Use these codes at checkout:</p>
          <table cellpadding="0" cellspacing="0">
            <tr>
              <td style="padding:6px 16px;background:#f59e0b;border-radius:6px;font-family:monospace;font-size:16px;font-weight:800;color:#1a1a1a;letter-spacing:2px;">LX1ZX6P</td>
              <td style="padding:6px 12px;color:#92400e;font-size:13px;">— 25% off your next developing order</td>
            </tr>
            <tr><td colspan="2" style="padding:4px 0;"></td></tr>
            <tr>
              <td style="padding:6px 16px;background:#f59e0b;border-radius:6px;font-family:monospace;font-size:16px;font-weight:800;color:#1a1a1a;letter-spacing:2px;">W67KQ4Z</td>
              <td style="padding:6px 12px;color:#92400e;font-size:13px;">— 15% off film</td>
            </tr>
          </table>
        </td></tr>
      </table>
      ${orderDetails(rollCount, filmType, filmProcess, orderNumber)}
      <p style="margin:0;color:#4b5563;font-size:14px;line-height:1.7;">
        Your film is on its way to Raleigh. Expect scans in <strong>up to 5 days (color)</strong> or <strong>8 days (B&amp;W)</strong> via WeTransfer.
      </p>
      ${btn("Track Your Order", `${BASE_URL}/tracking`)}
    `),
  };
...
// ─── Email 3: 10th drop-off loyalty milestone ─────────────────────────────
export function filmDropLoyalty10(params: {
  firstName: string;
  rollCount: number;
  filmType: string;
  filmProcess: string;
  ...
  const { firstName, rollCount, filmType, filmProcess, orderNumber } = params;
  return {
    subject: "Your 10th drop-off — you're amazing 🙌",
    html: layout("Yours Film Drop — 10th Visit!", `
      <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#1a1a1a;">Hey ${firstName}!</h1>
      <p style="margin:0;color:#4b5563;font-size:15px;line-height:1.6;">
        This is your <strong>10th time</strong> developing with us. That's so awesome — you're playing a real role in our ability to keep doing what we love. 🎞️
      </p>
      <!-- Loyalty reward -->
      <table width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0;background:#fffbeb;border:2px solid #f59e0b;border-radius:10px;">
        <tr><td style="padding:20px 24px;">
          <p style="margin:0 0 4px;color:#92400e;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;">Your 10th Visit Rewards</p>
          <p style="margin:0 0 16px;color:#78350f;font-size:14px;">
            We have a small <strong>bag of goodies</strong> for you next time you stop by! Just mention this email. 🎁
          </p>
          <table cellpadding="0" cellspacing="0">
            <tr>
              <td style="padding:6px 16px;background:#f59e0b;border-radius:6px;font-family:monospace;font-size:16px;font-weight:800;color:#1a1a1a;letter-spacing:2px;">2P64ZZM</td>
              <td style="padding:6px 12px;color:#92400e;font-size:13px;">— $20 off your next order</td>
            </tr>
            <tr><td colspan="2" style="padding:4px 0;"></td></tr>
            <tr>
              <td style="padding:6px 16px;background:#f59e0b;border-radius:6px;font-family:monospace;font-size:16px;font-weight:800;color:#1a1a1a;letter-spacing:2px;">PRINT50</td>
              <td style="padding:6px 12px;color:#92400e;font-size:13px;">— 50% off your next print order*</td>
            </tr>
          </table>
          <p style="margin:12px 0 0;color:#9ca3af;font-size:11px;">*Mention this email in store.</p>
        </td></tr>
      </table>
      ${orderDetails(rollCount, filmType, filmProcess, orderNumber)}
      <p style="margin:0;color:#4b5563;font-size:14px;line-height:1.7;">
